...
32 | 10:51 | [Áudio e Vídeo Avançados](https://www.youtube.com/watch?v=90uPbUirZ3I&list=PLHz_AreHm4dlAnJ_jJtV29RFxnPHDuk9o&index=35) | Aprimoramento do Audio e Video./ Posição do Video e Audio/ Imagem da TV e Radio/ **Video do Youtube:** Video -> Compatilhar -> Incorporar -> Pegar Link e Colar no Codigo
33 | 21:07 | [Formulários em HTML5 (parte 1)](https://www.youtube.com/watch?v=metoFY-x_yg&list=PLHz_AreHm4dlAnJ_jJtV29RFxnPHDuk9o&index=36) | Modificando a tela Fale Conosco/ tag **fieldset**(Conjunto de Campos, cria as bordas)/ tag **legend** (deixa o nome na borda)/ **input type="text" name="" id="" size="20"(20 caracteres) maxlength="3"(quantidade de caractere aceitos - aparecer) placeholder="digite aqui"**/ input **type="password"**/ input **type="email"**/ input **type="radio"**/ tag **label for="Id"**(clica no nome para selecionar a bolinha)/ input **type="date"**/ input **type="number" min="0" max="99999"**
